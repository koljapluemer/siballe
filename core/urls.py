...
urlpatterns = [
    ...
    path('dialogs/new/', views.dialog_create, name='dialog_create'),
    path('dialogs/<int:pk>/', views.dialog_detail, name='dialog_detail'),
    path('dialogs/<int:pk>/edit/', views.dialog_update, name='dialog_update'),
    path('dialogs/<int:pk>/delete/', views.dialog_delete, name='dialog_delete'),
    path('dialog-nodes/new/', views.dialog_node_create, name='dialog_node_create'),
    path('dialog-nodes/<int:pk>/edit/', views.dialog_node_update, name='dialog_node_update'),
    path('dialog-nodes/<int:pk>/delete/', views.dialog_node_delete, name='dialog_node_delete'),
    path('dialog-utterances/new/', views.dialog_utterance_create, name='dialog_utterance_create'),
    path('dialog-utterances/<int:pk>/edit/', views.dialog_utterance_update, name='dialog_utterance_update'),
    path('dialog-utterances/<int:pk>/delete/', views.dialog_utterance_delete, name='dialog_utterance_delete'),
    path('dialog-lines/new/', views.dialog_line_create, name='dialog_line_create'),
    path('dialog-lines/<int:pk>/edit/', views.dialog_line_update, name='dialog_line_update'),
    path('dialog-lines/<int:pk>/delete/', views.dialog_line_delete, name='dialog_line_delete'),
]
